          ...
          {messages.map((m) =>
            m.role === "user" ? (
              <div key={m.id} className="flex justify-end">
                <div className="max-w-[80%] rounded-2xl rounded-br-md bg-hx-bg border border-hx-line px-3.5 py-2.5 text-[14px] leading-relaxed whitespace-pre-wrap">{m.content}</div>
              </div>
            ) : (
