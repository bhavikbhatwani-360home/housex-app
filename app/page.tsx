  ...
  return (
    <div className="min-h-dvh bg-white text-hx-ink">
      ...
      <section className="px-6 pt-14 pb-12 text-center" style={{ background: "linear-gradient(to bottom, #ffffff, #FAFAFA)" }}>
        ...
        {/* quiet entry to the full catalogue — keeps the hero clean for the AI-first flow */}
        <Link href="/properties" className="mt-6 inline-flex items-center gap-1.5 text-[13px] font-semibold text-hx-slate hover:text-hx-red">
          Or browse all projects <ArrowRight className="w-3.5 h-3.5" />
        </Link>
