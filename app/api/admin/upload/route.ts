...
// Host listing media (photos, floor plans, brochure scans). With Vercel Blob
// configured (BLOB_READ_WRITE_TOKEN), images are uploaded and we store short
// public URLs — keeps the DB lean at scale. Without it, we pass the data URLs
// straight back so uploads still work (just stored inline). Either way the
// response says whether it hosted.
